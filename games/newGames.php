...
<div class='container'>
	<div class='page-header'>
		<h1>New Games<small>See the newest games and what's to be released</small>
	</div>
	<?php
		...
		$display = 8;
			...
			$q="SELECT profImgUrl, gamNam, descrip, DoR
				FROM games
				ORDER BY DoR DESC
				LIMIT $display";
			$r=mysqli_query($dbc, $q)
			...
			for($i = 1; $i<=4; $i++)
			{
				...
				echo "<div class='col-md-4'>
						<div class='thumbnail'>
						<a href='/gaming/games/game.php?g=" . $row['gamID'] . "&p=1&s=1' alt='" . $row['gamNam'] . " Page'>
							<img data-src='holder.js/300x200' alt='Game Image' src='/gaming/" . $row['profImgUrl'] . "'>
						</a>	
							<div class='caption'>
								<h3>" . $row['gamNam'] . "<small> On: " .$row['DoR']. "</small></h3>
								<p>" . $row['descrip'] . "</p>
								<a href='/gaming/games/game.php?g=" . $row['gamID'] . "&p=1&s=1' alt='" . $row['gamNam'] . " Page'>
	...
	<div class='col-md-4 col-md-offset-4'>
				...
				<?php
					...
					if($page>1)
					{
						...
						if($currentPage != 1)
						{
							echo "<li><a href='newGames.php?p=" . $page . "&s=" . ($start-6) . "'>&laquo;</a></li>";
						}
						for($i=1;$i<=$page;$i++)
						{
							echo "<li><a href='newGames.php?p=" . $page . "&s=" . (6*($i-1)) . "'>" . $i . "</a></li>";
						}
						if($currentPage!=$page)
						{
							echo "<li><a href='newGames.php?p=" . $page . "&s=" . ($start+6) . "'>&raquo;</a></li>";
